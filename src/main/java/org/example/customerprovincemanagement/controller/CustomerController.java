...
public class CustomerController {
    @Autowired
    private org.example.customerprovincemanagement.service.ICustomerService customerService;

    @Autowired
    private org.example.customerprovincemanagement.service.IProvinceService provinceService;
 ...
 /*   @GetMapping
    ...
    @GetMapping
    public ModelAndView listCustomer(@PageableDefault(2) Pageable pageable) {
